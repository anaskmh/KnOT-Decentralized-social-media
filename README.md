...
nostr-web-client/
├── backend/
│   ├── relay.py              # Main WebSocket relay server (NIP-01)
│   ├── storage.py            # SQLite event store + filter queries
│   └── requirements.txt
├── frontend/
│   ├── src/
...
│   │   ├── components/
│   │   │   ├── layout/
│   │   │   │   ├── AppLayout.jsx       # 3-column shell
│   │   │   │   ├── LeftSidebar.jsx     # Nav + profile + compose
│   │   │   │   ├── RightSidebar.jsx    # Search + trends + suggestions
│   │   │   │   └── MobileNav.jsx       # Bottom nav bar
│   │   │   ├── ui/
│   │   │   │   ├── Avatar.jsx          # Profile picture with fallback
│   │   │   │   ├── DisplayName.jsx     # Name + handle helpers
│   │   │   │   ├── NoteContent.jsx     # Renders text with links/hashtags
│   │   │   │   ├── Icon.jsx            # Material Symbols icons
│   │   │   │   ├── Header.jsx          # Page header with back button
│   │   │   │   └── NotificationToast.jsx  # Slide-in toast alerts
│   │   │   ├── Composer.jsx            # Collapsed pill → expanded post editor
│   │   │   ├── NoteCard.jsx            # Single post card with all actions
│   │   │   ├── Feed.jsx                # Feed list with spam filtering
│   │   │   ├── ReplyModal.jsx          # Reply composer modal
│   │   │   ├── ZapModal.jsx            # Lightning zap modal
│   │   │   ├── ShareModal.jsx          # Share to WhatsApp/Facebook/X/LinkedIn/Instagram
│   │   │   ├── EditProfileModal.jsx    # Edit profile form
│   │   │   ├── KeysModal.jsx           # View/copy keypair
│   │   │   └── UserRow.jsx             # Compact profile row
│   │   ├── pages/
│   │   │   ├── Home.jsx                # Home feed (Global / Following tabs)
│   │   │   ├── Profile.jsx             # User profile with banner + lightbox
│   │   │   ├── Thread.jsx              # Single post + likes/reposts/replies
│   │   │   ├── Explore.jsx             # Search + discovery
│   │   │   ├── Notifications.jsx       # Notification feed
│   │   │   ├── Bookmarks.jsx           # Saved posts
│   │   │   ├── Relays.jsx              # Relay connection status
│   │   │   └── settings/
│   │   │       ├── Settings.jsx              # Settings menu (drill-down)
│   │   │       ├── SettingsAccount.jsx       # Public/private key display
│   │   │       ├── SettingsAppearance.jsx    # Dark/light theme switcher
│   │   │       ├── SettingsMuted.jsx         # Muted users/words/hashtags
│   │   │       ├── SettingsModeration.jsx    # Hide sensitive / blur media
│   │   │       ├── SettingsZaps.jsx          # Default zap amount
│   │   │       └── SettingsNotifications.jsx # Notification type toggles
│   │   ├── context/
│   │   │   └── NostrContext.jsx         # Global state: identity, relay, profiles, notifications
│   │   ├── hooks/
│   │   │   ├── useFeed.js              # Fetch-then-stop feed with auto-refresh
│   │   │   ├── useEngagement.js        # Live likes/reposts/replies/zaps for a note
│   │   │   └── useFollowCounts.js      # Following/followers counts
│   │   └── nostr/
│   │       ├── relay.js                # RelayPool — connects to 4 relays, deduplicates events
│   │       ├── events.js               # Event builders (note, reply, reaction, repost, zap…)
│   │       ├── keys.js                 # Key generation, import, NIP-19 encoding
│   │       ├── format.js               # timeAgo, compactNumber, shortNpub, toNpub
│   │       ├── moderation.js           # Sensitive content detection
│   │       └── trends.js               # Derive trending hashtags + active authors
│   └── package.json
└── README.md
```
